       ...
       if (developed(g) > 0._r8) then ! == 1
          ...
          if (day < idop(p)) then
             ...
             if (patch%itype(p) >= npcropmin) then
                ...
                clteff_scalar(c,i_soil2) = 3.00_r8
                clteff_scalar(c,i_soil3) = 3.00_r8
             end if
             ...
             if (patch%itype(p) >= npcropmin) then
                ...
                clteff_scalar(c,i_litr3) = 1.50_r8
                clteff_scalar(c,i_soil1) = 1.00_r8
                clteff_scalar(c,i_soil2) = 1.60_r8
                clteff_scalar(c,i_soil3) = 1.60_r8
             end if
             ...
             if (patch%itype(p) >= npcropmin) then
                ...
                clteff_scalar(c,i_soil1) = 1.00_r8
                clteff_scalar(c,i_soil2) = 1.30_r8
                clteff_scalar(c,i_soil3) = 1.30_r8
             end if
